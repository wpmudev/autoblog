				...
				<table width="100%" class="feedtable">
					<tr>
						...
						<td valign='top'>
							...
							<?php echo $tips->add_tip( __( 'Enter a memorable title.', 'autoblogtext' ) ); ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top'>
							...
							<?php echo $tips->add_tip( __( 'Enter the feed URL.', 'autoblogtext' ) ); ?>
						</td>
					</tr>
					...
					<tr>
						...
						<?php if ( is_multisite() && is_network_admin() ) : ?>
							...
							<?php echo $tips->add_tip( __( 'Select a blog to add the post to.', 'autoblogtext' ) ) ?>
						<?php else : ?>
							<strong>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Select the post type the imported posts will have in the blog.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Select the status the imported posts will have in the blog.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Select the date imported posts will have.', 'autoblogtext' ) ) ?>
						</td>
					</tr>

					<?php do_action( 'autoblog_feed_edit_form_details_end', $this->feed_id, $this ) ?>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Select the author you want to use for the posts, or attempt to use the original feed author.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'If the feed author does not exist in your blog then use this author.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Assign this category to the imported posts.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Create any tags or categories that are needed.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Enter a comma separated list of tags to add.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'A post to be imported must have ALL of these words in the title or content.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'A post to be imported must have ANY of these words in the title or content.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'A post to be imported must have this exact phrase in the title or content.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'A post to be imported must NOT have any of these words in the title or content.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'A post to be imported must be marked with any of these categories or tags.', 'autoblogtext' ) ) ?>
							<br>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Use the full post (if available) or create an excerpt.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Specify the size of the excerpt to create (if selected)', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'If you want to link back to original source, enter a phrase to use here.', 'autoblogtext' ) ) ?>
							<br>
							<label>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'You can set this to only import a specific number of new posts rather than as many as the plugin can manage.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Set the time delay for processing this feed, irregularly updated feeds do not need to be checked very often.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Set the date you want to start processing posts from.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'Set the date you want to stop processing posts from this feed.', 'autoblogtext' ) ) ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign='top' class=''>
							...
							<?php echo $tips->add_tip( __( 'If you are getting SSL errors, or your feed uses a self-signed SSL certificate then set this to <strong>No</strong>.', 'autoblogtext' ) ) ?>
						</td>
					</tr>

					<?php do_action( 'autoblog_feed_edit_form_end', $key, $this ) ?>
				</table>
